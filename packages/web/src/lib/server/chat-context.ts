...
/**
 * Grounding instructions for the session chatbot. The model answers questions
 * strictly from the recorded material for one session.
 */
export const SESSION_CHAT_SYSTEM = `You are the Chronicler, an assistant that answers questions about a single recorded tabletop RPG session.
